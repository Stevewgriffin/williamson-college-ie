...
const PROGRAMS = [
  {
    ...
    courses: [
      { id: "LD201", code: "LD 201", name: "Biblical Concepts of Leadership", cr: 3, description: "Although the Bible is not specifically intended to be a leadership training manual, embedded on  almost every page of the text are significant leadership concepts and examples. The focus of this cours...", category: "core" },
      { id: "BL201", code: "BL 201", name: "Old Testament Studies I", cr: 3, description: "This course is a study of the early history of God’s people in the Old Testament as recorded from Genesis through Solomon. We will begin with an exploration of the Pentateuch, the five books of Moses,...", category: "core" },
      { id: "CT251", code: "CT 251", name: "Introduction to Biblical Worldview", cr: 3, description: "This course is designed to prepare students in thinking biblically in all of life’s situations. Utilizing Alpha International as a framework, students will explore various aspects of the Christian Fai...", category: "core" },
      { id: "BL202", code: "BL 202", name: "Old Testament Studies II", cr: 3, description: "This course is a study of the history of God’s people in the Old Testament from the Divided Monarchy through the Post-Babylonian Captivity. The foundation for the course will be the chronological sequ...", category: "core" },
      { id: "BL212", code: "BL 212", name: "New Testament Survey", cr: 3, description: "This Survey course will include core components for building a foundational understanding of the New Testament that will enrich more in-depth courses of study later. The first component will explore N...", category: "core" },
      { id: "ACCT301", code: "ACCT 301", name: "Principles of Accounting I", cr: 3, description: "ACCT 301 is a foundation course in principles of accounting designed primarily for accounting or business students as part of integrated business education. It is also helpful for any major who wishes...", category: "core" },
      { id: "ECON301", code: "ECON 301", name: "Principles of Macroeconomics", cr: 3, description: "The primary purpose of this course is to introduce you to the social science of economics and to examine this discipline&#039;s basic assumptions, methods, and models. Essential concepts such as suppl...", category: "core" },
      { id: "MGT311", code: "MGT 311", name: "Entrepreneurship and Small Business", cr: 3, description: "Creativity, opportunity, leadership, excellence and profit combined into an entrepreneurial approach to achieve the mission in small business.", category: "core" },
      { id: "MGT301", code: "MGT 301", name: "Essentials of Management", cr: 3, description: "A study of the five parts of managing organizations—planning, organizing, staffing, leading and controlling/evaluation—with the study of principles for application to both not-for-profit and for-profi...", category: "core" },
      { id: "CT330", code: "CT 330", name: "Christian Doctrine II", cr: 3, description: "Course Description  Using a systematic theology approach, this course will focus on the second five of the ten major doctrines of the Bible. Christology, the doctrine of Christ, will be the first them...", category: "core" },
      { id: "MGT361", code: "MGT 361", name: "Introduction to Sales", cr: 3, description: "This course focuses on building relationships which is the key to a successful sales career. The eight step sales cycle is studied and learned.  Attitude, one of the building blocks for achieving succ...", category: "core" },
      { id: "MGT381", code: "MGT 381", name: "Organizational Behavior", cr: 3, description: "Organizational goals, priorities and strategies interfacing with the behavior of individuals and groups inside the organization and in other affecting organizations. Attention given to the effect of o...", category: "core" },
      { id: "ACCT310", code: "ACCT 310", name: "Introduction to Finance", cr: 3, description: "This course focuses on the fundamental principles of finances. The basic knowledge, concepts, and terms of the discipline are appropriate for all students. Biblical concepts of sound financial decisio...", category: "core" },
      { id: "MKT361", code: "MKT 361", name: "Marketing", cr: 3, description: "Managers and their understanding of the role of marketing for an organization. Emphasis will be given to the factors that affect consumer behavior, the development and evaluation of an organization's...", category: "core" },
      { id: "MGT371", code: "MGT 371", name: "Managing Yourself, Managing Others", cr: 3, description: "Managers are only effective when they understand themselves well. Once they have insights into their own mental constructs, then they can influence others effectively. This course explores 1) the mana...", category: "core" },
      ...
      { id: "CT403", code: "CT 403", name: "Biblical Ethics", cr: 3, description: "This is a study of complexities of our modern world and how we live in it as Christians. This course will demonstrate that Christian ethics is ultimately rooted in the nature and actions of God and in...", category: "core" },
      { id: "LD471", code: "LD 471", name: "Leadership: Theory and Practice", cr: 3, description: "Course Description  What is leadership? How can you develop as a leader? This course explores this expansive topic not only covering several leadership theories but also attempting to provide practica...", category: "core" },
      { id: "MGT441", code: "MGT 441", name: "Principles and Issues in Business Risk", cr: 3, description: "This course will explore the various risks that businesses face daily. Dealing with Business Risk (BR) can be challenging for those who do not have a reliable moral and ethical foundation; hence, a Bi...", category: "core" },
      { id: "MGT489", code: "MGT 489", name: "Business Administration Capstone", cr: 3, description: "NOTE: This course&#039;s Zoom link is shared with MGT 489 Capstone due to limited Zoom room availability. Please contact the office if a conflict arises between the two capstone project meetings.  Thi...", category: "core" }
    ]
  },
  {
    ...
    courses: [
      { id: "OL500", code: "OL 500", name: "Critical Thinking", cr: 3, description: "This course is designed to provide a framework for gathering and evaluating the challenges leaders face globally.  The need for distinguishing between fact and fiction; sound principles and external b...", category: "core" },
      { id: "OL501", code: "OL 501", name: "Biblical Principles for Global Leadership", cr: 3, description: "This course is an examination and analysis of the qualities and practices of the effective Christian leader, particularly across cultural boundaries.  This study will be based on principles in Scriptu...", category: "core" },
      { id: "OL510", code: "OL 510", name: "Ethical Leadership in Public Life", cr: 3, description: "This course is a survey of the development of ethical thought, both ancient and modern. Various ethical systems and their proponents, including alternative Christian perspectives, will be covered alon...", category: "core" },
      { id: "OL530", code: "OL 530", name: "Organizational Culture", cr: 3, description: "This course is designed to create an understanding of the underlying patterns, values,  traditions, assumptions, and behaviors, both espoused and concealed, that make up what is  considered an organiz...", category: "core" },
      { id: "OL540", code: "OL 540", name: "Leading Through Change", cr: 3, description: "This course is an examination of change and its relationship to conflict within an organization.  This course will focus on enabling leaders to understand, anticipate, and direct change as well as how...", category: "core" },
      { id: "OL550", code: "OL 550", name: "Leading in a National Context", cr: 3, description: "This course is a special seminar that will consider the particular opportunities and challenges of leading at the national government and corporate levels.  Leaders from these contexts will predominat...", category: "core" },
      ...
      { id: "OL565", code: "OL 565", name: "Business Risk Management", cr: 3, description: "This course will explore the various risks that businesses face daily. Dealing with Business Risk (BR) can be challenging for those who do not have a reliable moral and ethical foundation; hence, a Bi...", category: "core" },
      { id: "OL570", code: "OL 570", name: "Financial Statement Analysis", cr: 3, description: "Course Description  This course examines the fundamental techniques of financial statement analysis and their application to strategic planning and decision-making. The course covers the analysis and...", category: "core" },
      { id: "OL575", code: "OL 575", name: "Strategic Planning", cr: 3, description: "This course is designed to train leaders how to think and plan strategically and to develop budgetary structure and discipline that will enable an organization to implement strategic plans.  Students...", category: "core" },
      { id: "OL590", code: "OL 590", name: "Dynamics of Leading in an International Context", cr: 3, description: "This course is designed to teach leadership, utilizing a biblical lens, through examples of cultural, political, and business dynamics in the countries of Belgium and United Kingdom. Topics will inclu...", category: "core" },
      { id: "OL599", code: "OL 599", name: "Capstone Project", cr: 3, description: "This is a leadership project, selected by the student, which will pertain to a particular opportunity or problem in their organization or ministry. The purpose of the Capstone is to help the student a...", category: "core" }
    ]
  },
  {
